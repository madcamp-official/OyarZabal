...
> [!NOTE]
> **한 줄 결론:** MLB 전체 기준선을 처음 확보했지만, 선수별 Specialist는
> 한 명도 검증을 통과하지 못했고 Accuracy만 높은 쏠림 모델의 위험이 드러났다.
...
> [!WARNING]
> Similarity의 Accuracy는 가장 높았지만 포심 예측 비율이 73.94%였고
> 커터·커브 recall은 0이었다. Accuracy만으로 모델을 선택하면 쏠림 모델을
> 고를 수 있다.
